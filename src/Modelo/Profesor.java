...
public class Profesor {
    ...
    public Profesor(int i, String nom, String ap1, String ap2, int ced, String nM, String ca, String ar, String cor){
        id = i;
        nombre = nom;
        apPaterno = ap1;
        apMaterno = ap2;
    ...
    public Profesor(String nom, String ap1, String ap2, int ced, String nM, String ca, String ar, String cor){
        nombre = nom;
        apPaterno = ap1;
        apMaterno = ap2;
        cedula = ced;
